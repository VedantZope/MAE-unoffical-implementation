...
CONFIGS=(
  "configs/pretraining/stl10/mae_vit_tiny_stl10_mask50_dec2.yaml"
  "configs/pretraining/stl10/mae_vit_tiny_stl10_mask75_dec2.yaml"
  "configs/pretraining/stl10/mae_vit_tiny_stl10_mask90_dec2.yaml"
  "configs/pretraining/stl10/mae_vit_tiny_stl10_mask50_dec4.yaml"
  "configs/pretraining/stl10/mae_vit_tiny_stl10_mask75_dec4.yaml"
  "configs/pretraining/stl10/mae_vit_tiny_stl10_mask90_dec4.yaml"
)

# GPU mapping:
# - Default: use 6 GPUs and skip GPU 2 (often flaky on some rigs).
# - Override by setting `GPU_IDS`, e.g.:
#     GPU_IDS="0,1,3,4,5,6" bash scripts/launch_stl10_ablations.sh
#     GPU_IDS="0 1 3 4 5 6" bash scripts/launch_stl10_ablations.sh
